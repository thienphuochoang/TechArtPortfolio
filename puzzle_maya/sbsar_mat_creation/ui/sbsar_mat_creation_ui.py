...
"color: rgb(85, 0, 0);")
        self.lbBakingSettings.setFrameShape(QFrame.Shape.StyledPanel)
        self.lbBakingSettings.setFrameShadow(QFrame.Shadow.Raised)
        self.lbBakingSettings.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.verticalSpacer_2 = QSpacerItem(20, 446, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.lwObjectSBSARMatList.setDragDropMode(QAbstractItemView.DragDropMode.NoDragDrop)
        ...
        self.lwObjectSBSARWeatherEffectList.setDragDropMode(QAbstractItemView.DragDropMode.NoDragDrop)
        self.lwObjectSBSARWeatherEffectList.setIconSize(QSize(128, 128))
        self.lwObjectSBSARWeatherEffectList.setMovement(QListView.Movement.Static)
        self.lwObjectSBSARWeatherEffectList.setFlow(QListView.Flow.TopToBottom)
        self.lwObjectSBSARWeatherEffectList.setProperty(u"isWrapping", False)
        self.lwObjectSBSARWeatherEffectList.setResizeMode(QListView.ResizeMode.Fixed)
        self.lwObjectSBSARWeatherEffectList.setViewMode(QListView.ViewMode.ListMode)
...
"color: rgb(255, 255, 255);")
        self.lbAssignedMaterials.setFrameShape(QFrame.Shape.StyledPanel)
        self.lbAssignedMaterials.setFrameShadow(QFrame.Shadow.Plain)
        self.lbAssignedMaterials.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"color: rgb(255, 255, 255);")
        self.lbAssignedWeatherEffects.setFrameShape(QFrame.Shape.StyledPanel)
        self.lbAssignedWeatherEffects.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.gbMatLibrary.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.lwThumbnailMatShowing.setDragDropMode(QAbstractItemView.DragDropMode.DragDrop)
        self.lwThumbnailMatShowing.setIconSize(QSize(128, 128))
        self.lwThumbnailMatShowing.setResizeMode(QListView.ResizeMode.Adjust)
        self.lwThumbnailMatShowing.setSpacing(0)
        self.lwThumbnailMatShowing.setViewMode(QListView.ViewMode.IconMode)
...
"color: rgb(255, 255, 255);")
        self.lbAddedMaterials.setFrameShape(QFrame.Shape.Box)
        self.lbAddedMaterials.setFrameShadow(QFrame.Shadow.Raised)
        self.lbAddedMaterials.setLineWidth(2)
        self.lbAddedMaterials.setAlignment(Qt.AlignmentFlag.AlignCenter)
